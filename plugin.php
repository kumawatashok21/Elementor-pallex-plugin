...
class Plugin {
	...
	public function __clone() {
		...
		_doing_it_wrong( __FUNCTION__, __( 'Cheatin&#8217; huh?', 'parallax-controls-for-elementor' ), '1.0.0' );
	}
	...
	private function _includes() {
		...
		require ELEMENTOR_CONTROLS_PATH . 'includes/parallax-functions.php';
	...
	public function elementor_controls_init() {
		...
		$elementor->elements_manager->add_category(
			...
			[
				'title' => __( 'Elementor Controls Elements', 'parallax-controls-for-elementor' ),
				'icon' => 'font',
			],
			1
		);
	...
	private function __construct() {
		...
		if ( is_admin() && current_user_can( 'activate_plugins' ) ) {
			new Parallax_Controls_Settings_API();
		}
